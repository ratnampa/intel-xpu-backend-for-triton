...
// CHECK: define spir_kernel void @test_intel_reqd_group_size() !intel_reqd_sub_group_size ![[REQD_SUB_GROUP_SIZE:.*]] !max_work_group_size ![[MAX_WORK_GROUP_SIZE:.*]] {
module attributes {gpu.spatial_extents = #gpu.spatial_extents<reqdSubgroupSize = 32 : i32, maxWorkgroupSize = [128, 1, 1]>} {
  llvm.func spir_kernelcc @test_intel_reqd_group_size() {
    llvm.return
  }
}
