...
def add(x: torch.Tensor, y: torch.Tensor):
    ...
    # It is analogous to xpu launch grids. It can be either Tuple[int], or Callable(metaparameters) -> Tuple[int].
    ...
    # We return a handle to z but, since `torch.xpu.synchronize()` hasn't been called, the kernel is still
