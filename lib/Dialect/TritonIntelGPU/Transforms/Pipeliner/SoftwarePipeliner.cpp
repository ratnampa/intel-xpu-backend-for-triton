...
static void pipelineLoop(scf::ForOp forOp, int numStages) {
  ...
  foundSchedule = mlir::triton::preProcessLoopAndGetScheduleIntel(
...
struct IntelGPUPipelinePass
  ...
  IntelGPUPipelinePass(int numStages) {
...
std::unique_ptr<Pass> mlir::createTritonIntelGPUPipelinePass(int numStages) {
